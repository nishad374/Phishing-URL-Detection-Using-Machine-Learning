...
class FeatureExtraction:
    def __init__(self, url):
        ...
        try:
            self.response = requests.get(url, timeout=10, headers={'User-Agent': 'Mozilla/5.0'})
    ...
    # 31. SSLfinal_State - The missing feature
...
# Function to generate dataset for a URL
def generate_data_set(url):
    # Create feature extraction object
    feature_extraction = FeatureExtraction(url)
    return feature_extraction.getFeaturesList()